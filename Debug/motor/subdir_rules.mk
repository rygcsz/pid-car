...
motor/%.o: ../motor/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"D:/ccs/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O2 -I"D:/workspace/empty1" -I"D:/workspace/empty1/Debug" -I"D:/workspace/empty1/motor" -I"D:/ccs/mspm0_sdk_2_10_00_04/source/third_party/CMSIS/Core/Include" -I"D:/ccs/mspm0_sdk_2_10_00_04/source" -gdwarf-3 -Wall -MMD -MP -MF"motor/$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
